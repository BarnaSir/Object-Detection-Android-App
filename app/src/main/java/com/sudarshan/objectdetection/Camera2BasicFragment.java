...
public class Camera2BasicFragment extends Fragment
  ...
  public View onCreateView(
    ...
    return inflater.inflate(com.sudarshan.objectdetection.R.layout.fragment_camera2_basic, container, false);
  }

  /** Connect the buttons to their event handler. */
  @Override
  public void onViewCreated(final View view, Bundle savedInstanceState) {
    textureView = view.findViewById(com.sudarshan.objectdetection.R.id.texture);
    textView = view.findViewById(com.sudarshan.objectdetection.R.id.text);
...
//    confidenceLevelView = view.findViewById(R.id.confidence_level);
  ...
  private void setUpCameraOutputs(int width, int height) {
    ...
    try {
      ...
      ErrorDialog.newInstance(getString(com.sudarshan.objectdetection.R.string.camera_error))
